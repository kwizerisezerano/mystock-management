...
<tr><th colspan="2"><h4  style="color:darkblue;font-family:helvetica; "><center>Welcome to deletion</center></h4></th>
<tr>
<td>Product ID</td>
<td><input type="number"  required="" name="pid"></td>
</tr>
<tr>
<td><input type="submit" value="Delete product"style="background-color:blue;color:white;width:250px;height:30px;border-radius:5px;border:0px;"></td>
...
String  pid = request.getParameter("pid");
   ...
   String update="DELETE FROM `products`  WHERE productid=?";
     
   PreparedStatement inserti = conn.prepareStatement(update);
   
  
   inserti.setString(1,pid);
