...
<tr><th colspan="2"><h4  style="color:darkblue;font-family:helvetica; "><center>Welcome to product modification</center></h4></th>
<tr>
<td>Product ID</td>
<td><input type="number"  required="" name="pid"></td>
</tr>
...
<tr>
<td>Product marc</td>
<td><input type="text"  required="" name="pmarc"></td>
</tr>
<tr>
<td>Product size</td>
...
<tr>
<td>Product type</td>
<td><input type="text"  required="" name="ptype"></td>
</tr>
<td>Product price</td>
<td><input type="text"required="" name="price"></td>
</tr>
<tr>
<td><input type="submit" value="Modify product"style="background-color:blue;color:white;width:250px;height:30px;border-radius:5px;border:0px;"></td>
...
String price =request.getParameter("price");
   ...
   String update="UPDATE `products` SET `name`=? ,`marc`=?,`size`=?,`type`=?,`prce`=? WHERE productid=?";
     
   PreparedStatement inserti = conn.prepareStatement(update);
