...
<tr><th colspan="2"><h4  style="color:darkblue;font-family:helvetica; "><center>Welcome to buyers records modification</center></h4></th>
<tr>
<td>Buyer ID</td>
...
String price =request.getParameter("price");
   ...
   String insert="UPDATE `buyers` SET `buyername`=?,`pname`=?,`bdate`=?,`price`=? WHERE buyerid=?";
