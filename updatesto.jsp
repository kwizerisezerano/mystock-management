...
<tr><th colspan="2"><h4  style="color:darkblue;font-family:helvetica; "><center>Welcome to store record modification</center></h4></th>
<tr>
<td>Stock ID</td>
...
<tr>
<td><input type="submit" value="update record"style="background-color:blue;color:white;width:250px;height:30px;border-radius:5px;border:0px;"></td>
...
String outdate =request.getParameter("outate");
   ...
   String insert="UPDATE `store` SET `stockname`=?,`manager`=?,`ingoing`=?,`ingoingdate`=?,`outgoing`=?,`outgoingdate`=?  WHERE stroreid=?";
