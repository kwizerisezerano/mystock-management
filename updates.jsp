...
<tr><th colspan="2"><h4  style="color:darkblue;font-family:helvetica; "><center>Welcome to sellers records modification</center></h4></th>
<tr>
<td>Seller ID</td>
<td><input type="text" required="" name="sid"></td>
</tr>
<tr>
<td>Seller name</td>
...
<tr>
<td><input type="submit" value="Modify record" style="background-color:blue;color:white;width:250px;height:30px;border-radius:5px;border:0px;"></td>
...
String price =request.getParameter("price");
   ...
   String insert="UPDATE `sellers` SET`sellername`=?,`pname`=?,`sdate`=?,`price`=? WHERE sellerid=?";
