...
<tr><th colspan="2"><h4  style="color:darkblue;font-family:helvetica; "><center>Welcome to buyers records manager</center></h4></th>
<tr>
<td>Buyer name</td>
...
String price =request.getParameter("price");
   ...
   String insert="INSERT INTO `buyers`(`buyername`, `pname`, `bdate`, `price`) VALUES  ( ?, ?, ?, ?)";
