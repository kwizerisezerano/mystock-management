...
<tr><th colspan="2"><h4  style="color:darkblue;font-family:helvetica; "><center>Welcome to sellers records deletion</center></h4></th>
<tr>
<td>Seller ID</td>
...
String sid =request.getParameter("sid");
   ...
   String insert="DELETE FROM `sellers` WHERE sellerid=?";
     
   PreparedStatement inserti = conn.prepareStatement(insert);
   
  
   inserti.setString(1,sid);
